...
is_deeply([ [ 0, 9, 0, [ 0..9 ] ], [ 20, 29, 20, [ 20..29 ] ] ], \@entries);

@entries = $rcache->get('foobar', 5, 29);
is_deeply([ [ 5, 9, 5, [ 5..9 ] ], [ 20, 29, 20, [ 20..29 ] ] ], \@entries);

@entries = $rcache->get('foobar', 0, 24);
is_deeply([ [ 0, 9, 0, [ 0..9 ] ], [ 20, 24, 20, [ 20..24 ] ] ], \@entries);

@entries = $rcache->get('foobar', 5, 24);
is_deeply([ [ 5, 9, 5, [ 5..9 ] ], [ 20, 24, 20, [ 20..24 ] ] ], \@entries);
...
@entries = $rcache->get('foobar', -30, 50);
is_deeply([ [ 0, 9, 0, [ 0..9 ] ], [ 10, 19, 10, [ 10..19 ] ], [ 20, 29, 20, [ 20..29 ] ] ], \@entries);
...
@entries = $rcache->get('barfoo', 0, 9);
is_deeply([ [ 0, 4, 0, [ 0..4 ] ], [ 5, 9, 5, [ 5..9 ] ] ], \@entries);

sleep 5;

@entries = $rcache->get('barfoo', 0, 9);
is_deeply([ [ 5, 9, 5, [ 5..9 ] ] ], \@entries);
